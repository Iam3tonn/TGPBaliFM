...
def handle_message(update: Update, context: CallbackContext):
    ...
    if text == 'Bagus':
        ...
        if 'article_text' in user_data and 'choice' in user_data:
            send_to_chatgpt(update, context)
        else:
            update.message.reply_text('Не найден текст статьи или выбор для переписывания. Пожалуйста, начните заново.')
    else:
