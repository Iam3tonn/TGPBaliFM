...
def send_to_chatgpt(update: Update, context: CallbackContext):
    ...
    try:
        response = requests.post("https://api.openai.com/v1/chat/completions",
                                 headers={"Authorization": f"Bearer {CHATGPT_API_TOKEN}", "OpenAI-Organization": "org-ERAMgQBgyjrEfpSo47e39rq0"}, 
                                 json={
                                     "model": "gpt-3.5-turbo",
